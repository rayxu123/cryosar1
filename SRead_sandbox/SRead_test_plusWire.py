...
Ray Xu
Nov 2022
cryosar1/SRead/SRead_test_plusWire.py
...
if __name__ == "__main__":
    ...
    xem.ConfigureFPGA('pipein_out_plusWire.bit')
    ...
    # Prepare the word to add.  The 8 LED's are mapped to the 8 LSB's.
    xem.SetWireInValue(0x01, 0x000000aa)
    xem.UpdateWireIns()
    time.sleep(0.01)
