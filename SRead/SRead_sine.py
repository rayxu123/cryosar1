...
if __name__ == "__main__":
    ...
    print("Calibrated ODAC Mean: \""+str(cal.odac_mean)+"\"")
    print("Calibrated ODAC force 0: \""+str(cal.odac_force0)+"\"")
    print("Calibrated ODAC force 1: \""+str(cal.odac_force1)+"\"")
    ...
    f.write(cal.odac+"\n")
    f.write("ODAC Mean\n")
    f.write(str(cal.odac_mean)+"\n")
    f.write("ODAC force 0\n")
    f.write(str(cal.odac_force0)+"\n")
    f.write("ODAC force 1\n")
    f.write(str(cal.odac_force1)+"\n")
    f.write("WEIGHTS\n")
