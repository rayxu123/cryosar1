...
if __name__ == "__main__":
    ...
    parser.add_argument('--numpts', dest='numpts', action='store', default=256, type=int, help="Number of linearly space amplitude points.  (Defualt: 256)")
    ...
    '''
    awg_list = np.linspace(0.01, 10, num=10, endpoint=True)
    print(awg_list)
    awg_list = np.logspace(np.log2(0.01), np.log2(10), num=100, endpoint=True, base=2)
    print(awg_list)
    '''
    exit()
